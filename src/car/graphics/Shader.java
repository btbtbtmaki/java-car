...
public class Shader {
	...
	public static Shader BG, PLAYER, BLOCK, FADE,ENDFADE;
	...
	public static void loadAll() {
		...
		ENDFADE = new Shader("shaders/endfade.vert", "shaders/endfade.frag");
	}
